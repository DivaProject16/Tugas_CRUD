...
export class Tab3Page {
  ...
  async getData() {
    ...
    try{
      const res= await axios.post('http://localhost/apk_crud/get_data_mahasiswaId.php', fd);
  ...
  async updateData() {
    ...
    try{
      const res = await axios.post('http://localhost/apk_crud/update_data_mahasiswa.php', fd);
