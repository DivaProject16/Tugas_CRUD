...
export class Tab2Page {
  ...
  async getData() {
    try{
      const res = await axios.get('http://localhost/apk_crud/get_data_mahasiswa.php');
  ...
  async deleteData(id) {
    ...
    fd.append('id', id);
    try{
      const res = await axios.post('http://localhost/apk_crud/delete_data_mahasiswa.php', fd);
